...
namespace POS_System.Model
{
    public partial class FrmProductAdd : Form
    {
        ...
        private string ValidateInputs()
        {
            ...
            if (string.IsNullOrWhiteSpace(TxtBarcode.Text) || TxtBarcode.Text.Length < 5 || !TxtBarcode.Text.All(char.IsDigit))
            {
                validationErrors.AppendLine("Barcode must be a numeric value with at least 5 digits.");
            }
